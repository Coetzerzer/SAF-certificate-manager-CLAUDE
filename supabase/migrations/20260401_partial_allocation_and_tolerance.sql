-- Migration: Improve allocation tolerance and add partial_linked status
-- 1. Align success tolerance from 0.000001 to 0.002 (matches client-side MATCH_TOLERANCE)
-- 2. Add partial_linked status: when some but not all volume is allocated, save links instead of discarding
